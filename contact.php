...
<html lang="nl">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="index.html"><strong>DUAL</strong>BIT</a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading">Wij raadplegen u zo snel mogelijk terug!</h3>
          </div>
        </div>
        <div class="row info">
          <div class="col-lg-12">
               <p>Hieronder kunt u uw ingevoerde informatie terug vinden.</p>
